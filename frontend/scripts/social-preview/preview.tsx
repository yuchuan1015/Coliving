...
createRoot(document.getElementById("root")!).render(<AuthContext.Provider value={{ user, isLoading: false, login: denied, register: denied, logout() {}, updateLocation: denied, updateBirthYear: denied, refreshUser: async () => user }}><MemoryRouter>
