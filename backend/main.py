...
from routers import admin, adult, agents, ai_chat, announcements, auth, chat, credit, diary, dining, footprints, furniture, health, history, home, internal_memory, library, memory, mail, reading, museum, outfits, park, pet, posts, review, schedules, shell, skins, users, weilan
